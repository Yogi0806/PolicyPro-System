...
* The original package name 'com.lic.Spring-boot-insurance-management-platform' is invalid and this project uses 'com.lic.Springbootinsurancemanagementplatform' instead.
